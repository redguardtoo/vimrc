...
Pathogen let us install a plugin as a bundle in ~/.vim/bundle separately.

** [[https://github.com/preservim/nerdtree][Nerd Tree]]
A tree explorer plugin for navigating the filesystem. Press ",nt".
...
Maintains a history of previous yanks, changes and deletes. Press ",yy"
...
Undo and redo in tree. Press ",ut" to show the ui
